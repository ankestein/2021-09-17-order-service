...
class OrderRepoTest {
    ...
    @Test
    @DisplayName("addOrder() should add an order to OrderRepo")
    ...
    @Test
    @DisplayName("addOrder() used on an empty OrderRepo should add an order")
    ...
    public void testAddOrderWithSameIdException() {
        ...
        // when
        try {
            orderRepo.addOrder(new Order("2", new ArrayList<Product>(List.of(new Product(222, "stapler")))));    fail("Exception not thrown!");
